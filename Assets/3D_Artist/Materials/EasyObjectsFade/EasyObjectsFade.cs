...
public class EasyObjectsFade : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        RaycastHit[] hits1 = Physics.SphereCastAll(position, radius, direction, rayDistance, layerMask);
        ...
        if (detectFromInsideCollider)
        {
            ...
            RaycastHit[] hits2 = Physics.SphereCastAll(position, radius, direction, rayDistance, layerMask);
